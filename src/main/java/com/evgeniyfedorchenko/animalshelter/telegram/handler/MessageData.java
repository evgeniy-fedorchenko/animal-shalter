...
//    Кнопка юзера, по нажатию он получает это сообщение
    ENDING_VOLUNTEER_CHAT(VolunteerChattingEnd.class.getSimpleName(), "Диалог завершен. Вы можете продолжить пользоваться ботом в обычном режиме"),
...
//    Колбек для волонтера, показывается ему, когда юзер завершил диалог
    ...
    SEND_REPORT_END(SendReportEnd.class.getSimpleName(), """
            Вы молодец! 👏🎉 Спасибо за ответы о вашем питомце:
