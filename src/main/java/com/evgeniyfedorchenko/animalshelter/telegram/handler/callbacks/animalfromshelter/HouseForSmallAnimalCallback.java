...
@Component
public class HouseForSmallAnimalCallback implements Callback {

    private final CallType callType = HOUSE_FOR_SMALL_ANIMAL;
    ...
    public EditMessageText apply(String chatId, Integer messageId) {
        ...
        Map<String, String> keyboardData = new LinkedHashMap<>() {{
            put("Back", MAIN_HOW_TAKE_ANIMAL.getTitle()); // есть
        }};
